/** Default circular crop for team headshots on About / Team pages */
export const TEAM_AVATAR_IMG_CLASS =
  'h-full w-full origin-[center_30%] scale-[1.18] object-cover object-[center_24%]'
export const TEAM_AVATAR_IMG_CLASS_WIDE =
  'h-full w-full object-cover object-[center_23%]'
...
export const aboutTeamMembers = [
  ...
  },
  {
    ...
    avatarImgClass: TEAM_AVATAR_IMG_CLASS_WIDE,
  },
  {
  ...
  },
  {
    ...
    role: 'Receptionist',
    credentials: '',
    bio: 'Inayah welcomes guests with warmth and professionalism and keeps check-ins running smoothly so every visit begins with ease.',
    image: '/team-inayah.png',
  },
]
