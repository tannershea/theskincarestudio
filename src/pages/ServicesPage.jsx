...
const serviceIcons = {
  "Gift Cards": <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v-1.5a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 11.25v1.5m18 0A2.25 2.25 0 0118.75 15h-15A2.25 2.25 0 012.25 12.75v-1.5m18 0V9a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9v1.5m18 0V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v1.5m18 0V4.5A2.25 2.25 0 0018.75 2.25h-15A2.25 2.25 0 012.25 4.5v1.5" /></svg>,
  "Wellness Facial": <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></svg>,
  ...
  "Wellness Neurotoxin": <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3v3.75m0 0L6 9m3.75-2.25L6 4.5m3.75 2.25h4.5m0 0V3m0 3.75L18 9m-3.75-2.25L18 4.5m-3.75 2.25v13.5a2.25 2.25 0 01-4.5 0V6.75" /></svg>,
  ...
  "B-12 Shot": <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3v3.75m0 0L6 9m3.75-2.25L6 4.5m3.75 2.25h4.5m0 0V3m0 3.75L18 9m-3.75-2.25L18 4.5m-3.75 2.25v13.5a2.25 2.25 0 01-4.5 0V6.75" /></svg>,
  "Glutathione Shot": <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3v3.75m0 0L6 9m3.75-2.25L6 4.5m3.75 2.25h4.5m0 0V3m0 3.75L18 9m-3.75-2.25L18 4.5m-3.75 2.25v13.5a2.25 2.25 0 01-4.5 0V6.75" /></svg>,
  ...
  "SkinPen Microneedling with VAMP": <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" /></svg>,
...
function ServiceRow({ service, groupTitle, bookLabel = 'Book now' }) {
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:mt-8 sm:gap-6">
              ...
              <figure className="flex min-w-0 w-full flex-col">
                <button
                  ...
                  className="group relative cursor-zoom-in overflow-hidden rounded-xl border border-slate-200 bg-white text-left shadow-sm transition hover:border-accentBlue/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accentBlue sm:rounded-2xl"
                  aria-label="View larger: PRFM Small Area before and after"
                >
                  <img
