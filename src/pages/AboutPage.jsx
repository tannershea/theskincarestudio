            ...
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.4fr]">
              ...
              <div className="grid grid-cols-3 gap-2 sm:grid-cols-4">
                {['Stratford', 'Norwalk', 'Stamford', 'Bridgeport', 'Trumbull', 'Shelton', 'Fairfield', 'Milford'].map((town) => (
                  <div key={town} className="rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-center text-[13px] font-medium text-slate-600 transition-all duration-200 hover:border-accentBlue/20 hover:text-accentNavy">
                    {town}
                  </div>
                ))}
              </div>
